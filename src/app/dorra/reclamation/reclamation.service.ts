...
import { Reponse } from '../reponse/reponse.module';
...
export class ReclamationService {
  ...
  private apiURL = 'http://localhost:9100/DevDream/reclamation';

  constructor(private http: HttpClient) { }

  getReclamations(): Observable<Reclamation[]> {
    return this.http.get<Reclamation[]>("http://localhost:9100/DevDream/reclamation/retrieve-all-reclamations");
  }
  ...
  addReclamation(reclamation: Reclamation): Observable<Reclamation> {
    ...
    return this.http.post<Reclamation>("http://localhost:9100/DevDream/reclamation/add-reclamation", reclamation);
  }
