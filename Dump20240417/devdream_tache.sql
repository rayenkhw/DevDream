...
CREATE TABLE `tache` (
  `id_tache` bigint NOT NULL AUTO_INCREMENT,
  ...
  KEY `FKsog9wpvwhp0smxy728eiqxncr` (`encadrant_id`),
  KEY `FK9h1cbnlxqefr2otkfw72fs66f` (`etudiant_id`),
  CONSTRAINT `FK9h1cbnlxqefr2otkfw72fs66f` FOREIGN KEY (`etudiant_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKsog9wpvwhp0smxy728eiqxncr` FOREIGN KEY (`encadrant_id`) REFERENCES `user` (`id`)
...
INSERT INTO `tache` VALUES (1,'Todo','jjj','hhh','ggg',12,'ff',NULL,6);
