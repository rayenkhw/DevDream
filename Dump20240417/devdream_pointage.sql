...
CREATE TABLE `pointage` (
  ...
  `nb_abs` int DEFAULT NULL,
  `stage_id_stage` bigint DEFAULT NULL,
  PRIMARY KEY (`id_pointage`),
  KEY `FKggwr6ekxvj9k7co4kde8kt4yo` (`stage_id_stage`),
  CONSTRAINT `FKggwr6ekxvj9k7co4kde8kt4yo` FOREIGN KEY (`stage_id_stage`) REFERENCES `stage` (`id_stage`)
