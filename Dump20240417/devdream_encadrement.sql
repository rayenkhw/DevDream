...
--
-- Table structure for table `encadrement`
--
...
CREATE TABLE `encadrement` (
  ...
  KEY `FKkqvxhinkrka6ksxievbsrxu0a` (`encadrant_id`),
  KEY `FKr3fu793vpstsge2u4figslxn0` (`etudiant_id`),
  CONSTRAINT `FKkqvxhinkrka6ksxievbsrxu0a` FOREIGN KEY (`encadrant_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKr3fu793vpstsge2u4figslxn0` FOREIGN KEY (`etudiant_id`) REFERENCES `user` (`id`)
...
INSERT INTO `encadrement` VALUES (1,8,6);
