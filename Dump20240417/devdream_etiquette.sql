...
CREATE TABLE `etiquette` (
  `id_etiquette` bigint NOT NULL AUTO_INCREMENT,
  `text` varchar(255) DEFAULT NULL,
  `tache_id_tache` bigint DEFAULT NULL,
  PRIMARY KEY (`id_etiquette`),
  KEY `FKeqaw7p04af4keug8lf33hqs3u` (`tache_id_tache`),
  CONSTRAINT `FKeqaw7p04af4keug8lf33hqs3u` FOREIGN KEY (`tache_id_tache`) REFERENCES `tache` (`id_tache`)
