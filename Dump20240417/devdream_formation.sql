...
CREATE TABLE `formation` (
  ...
  `disponiblite` bit(1) DEFAULT NULL,
  `mot_cle` varchar(255) DEFAULT NULL,
  `nombre_likes` int DEFAULT '0',
  `titre` varchar(255) DEFAULT NULL,
  `formation_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id_formation`),
  KEY `FK6fclxh4paos0jrdn0idt384mx` (`formation_id`),
  CONSTRAINT `FK6fclxh4paos0jrdn0idt384mx` FOREIGN KEY (`formation_id`) REFERENCES `user` (`id`)
...
INSERT INTO `formation` VALUES (1,'2024-04-17 13:31:42.955000','2024-04-02','2024-08-02','Angular chez amine minou ',NULL,NULL,1,'Angular',NULL);
